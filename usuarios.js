            ...
            <form id="userForm">
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  ...
                  <small style="color: var(--color-text-secondary);">Apenas para operadores</small>
                </div>
              </div>
              <div class="form-row">
                <div class="form-group">
  ...
  async onSubmit(event) {
    ...
    try {
      if (this.editingUserId) {
        ...
        const { data: existing } = await sistema.supabase.from('usuarios').select('id').eq('username', username).single();
        if (existing) {
